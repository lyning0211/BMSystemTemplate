...
(
	...
	CONSTRAINT PK_SA_Role PRIMARY KEY (RoleGUID)
)
GO
INSERT INTO dbo.SA_Role(RoleGUID,RoleName,RoleType,RoleNote,Create_Time) VALUES ('E3AFED0047B08059D0FADA10F400C1E5', '超级管理员', 'sa', '系统默认添加账号，拥有所有权限',GETDATE());
GO
--设置唯一键
...
(
	...
	UserRoleGUID  VARCHAR(36) NOT NULL, --角色GUID
	Phone         VARCHAR(15) NULL, --联系电话
	Email         VARCHAR(100) NULL, --邮箱账号
	Create_Time	  DATETIME NOT NULL, --创建时间
	CONSTRAINT PK_SA_User PRIMARY KEY (UserGUID)
)
GO
--设置唯一键
...
GO
INSERT INTO dbo.SA_User(UserGUID,UserName,UserPassWord,UserSex,UserRoleGUID,UserStatus,Phone,Email,Create_Time) VALUES (NEWID(), 'sa', 'E10ADC3949BA59ABBE56E057F20F883E', '', 'E3AFED0047B08059D0FADA10F400C1E5',0,NULL,NULL,GETDATE());
GO
...
GO
-- 创建索引
CREATE INDEX IX_SA_RolePermission ON dbo.SA_RolePermission (RoleGUID,ModuleID);
GO
...
(
	...
	Create_Time	  DATETIME NOT NULL, --创建时间
	CONSTRAINT PK_SA_Department PRIMARY KEY (DepartmentGUID)
)
GO
--设置唯一键
...
(
    ...
    UserGUID        VARCHAR(36) NOT NULL,     --用户GUID
	UserName        NVARCHAR(100) NOT NULL, --用户名
	UserRoleGUID    VARCHAR(36) NOT NULL, --用户角色GUID
...
GO
-- 创建索引
CREATE INDEX IX_Log_Login ON dbo.Log_Login (UserGUID, Operation_Time, Operation_IP);
GO
...
(
	...
	UserGUID	    VARCHAR(36) NOT NULL, --操作用户GUID
	UserName        NVARCHAR(100) NOT NULL, --操作用户名
	UserRoleGUID    VARCHAR(36) NOT NULL, --操作用户角色GUID
...
GO
-- 创建索引
CREATE INDEX IX_Log_Operation ON dbo.Log_Operation (Object_Name,UserGUID,UserRoleGUID,Operation_Time,Operation_Type,Operation_IP);
GO
...
GO
-- 主查询索引（键长度172字节）
CREATE INDEX IX_Log_Trace_Main ON dbo.Log_Trace (Object_Type, Object_GUID) INCLUDE (UserGUID, UserName, Operation_Time);
GO
-- 审计查询索引（键长度272字节）
...
SELECT a.*,b.RoleName
FROM dbo.SA_User a
LEFT JOIN dbo.SA_Role b ON a.UserRoleGUID=b.RoleGUID
GO
...
SELECT a.LogID,a.UserGUID,a.UserRoleGUID,a.Operation_Time,a.Operation_IP,a.Operation_Note,
	ISNULL(b.UserName,a.UserName) AS UserName,ISNULL(b.RoleName,a.UserRoleName) AS UserRoleName
FROM dbo.Log_Login a
LEFT JOIN dbo.SA_User_v b ON a.UserGUID=b.UserGUID
GO
...
SELECT a.LogID,a.Object_Name,a.UserGUID,a.UserRoleGUID,a.Operation_Time,a.Operation_Type,
...
--角色信息日志
SELECT a.LogID,a.Object_Type,a.Object_GUID,ISNULL(c.RoleName,a.Object_Name) AS Object_Name,a.Object_Field,a.Old_Value,a.New_Value,a.UserGUID,a.UserRoleGUID,a.Operation_Time,
...
UNION
--账号信息日志
SELECT a.LogID,a.Object_Type,a.Object_GUID,ISNULL(c.UserName,a.Object_Name) AS Object_Name,a.Object_Field,a.Old_Value,a.New_Value,a.UserGUID,a.UserRoleGUID,a.Operation_Time,
	a.Operation_Type,a.Operation_Note,a.Operation_IP,ISNULL(b.UserName,a.UserName) AS UserName,ISNULL(b.RoleName,a.UserRoleName) AS UserRoleName
FROM dbo.Log_Trace a
LEFT JOIN dbo.SA_User_v b ON a.UserGUID=b.UserGUID
...
UNION
--部门信息日志
SELECT a.LogID,a.Object_Type,a.Object_GUID,ISNULL(c.DepartmentName,a.Object_Name) AS Object_Name,a.Object_Field,a.Old_Value,a.New_Value,a.UserGUID,a.UserRoleGUID,a.Operation_Time,
	a.Operation_Type,a.Operation_Note,a.Operation_IP,ISNULL(b.UserName,a.UserName) AS UserName,ISNULL(b.RoleName,a.UserRoleName) AS UserRoleName
FROM dbo.Log_Trace a
LEFT JOIN dbo.SA_User_v b ON a.UserGUID=b.UserGUID
...
UNION
--学历信息日志
SELECT a.LogID,a.Object_Type,a.Object_GUID,ISNULL(c.EducationalBackgroundName,a.Object_Name) AS Object_Name,a.Object_Field,a.Old_Value,a.New_Value,a.UserGUID,a.UserRoleGUID,a.Operation_Time,
	a.Operation_Type,a.Operation_Note,a.Operation_IP,ISNULL(b.UserName,a.UserName) AS UserName,ISNULL(b.RoleName,a.UserRoleName) AS UserRoleName
FROM dbo.Log_Trace a
LEFT JOIN dbo.SA_User_v b ON a.UserGUID=b.UserGUID
...
UNION
--参数配置信息日志
SELECT a.LogID,a.Object_Type,a.Object_GUID,ISNULL(c.ParameterName,a.Object_Name) AS Object_Name,a.Object_Field,a.Old_Value,a.New_Value,a.UserGUID,a.UserRoleGUID,a.Operation_Time,
	a.Operation_Type,a.Operation_Note,a.Operation_IP,ISNULL(b.UserName,a.UserName) AS UserName,ISNULL(b.RoleName,a.UserRoleName) AS UserRoleName
FROM dbo.Log_Trace a
LEFT JOIN dbo.SA_User_v b ON a.UserGUID=b.UserGUID
...
INSERT INTO dbo.SA_Module(ModuleID,ModuleName,ParentID,Link,OrderNo,IsDisplay,IsFirstMenu,Flag,Create_Time) 
VALUES (104, '学历管理', 1, '/Project/EducationalBackgroundIndex', 4, 'Y', 'N', NULL,GETDATE());
--系统设置9
INSERT INTO dbo.SA_Module(ModuleID,ModuleName,ParentID,Link,OrderNo,IsDisplay,IsFirstMenu,Flag,Create_Time) 
