    ...
    public class LogInfoDAL
    {
        ...
        public static DataTable GetLogLoginTable(int pageIndex, int pageSize, string fieldName, string myWhere, string myOrderBy)
        {
            ...
            try
            {
                ...
                {
                    //分页查询
                    sqlStr = CommonDAL.GetPagingSQL(pageIndex, pageSize, "Log_Login_v", fieldName, "LogID", myWhere, myOrderBy);
                }
        ...
        public static DataTable GetLogOperationTable(int pageIndex, int pageSize, string fieldName, string myWhere, string myOrderBy)
        {
            ...
            try
            {
                ...
                {
                    //分页查询
                    sqlStr = CommonDAL.GetPagingSQL(pageIndex, pageSize, "Log_Operation_v", fieldName, "LogID", myWhere, myOrderBy);
                }
                dt = DBHelper.GetDataTable(sqlStr);
            }
            catch (Exception ex)
        ...
        public static DataTable GetLogTraceTable(int pageIndex, int pageSize, string fieldName, string myWhere, string myOrderBy)
        {
            ...
            try
            {
                ...
                {
                    //分页查询
                    sqlStr = CommonDAL.GetPagingSQL(pageIndex, pageSize, "Log_Trace_v", fieldName, "LogID", myWhere, myOrderBy);
                }
                dt = DBHelper.GetDataTable(sqlStr);
            }
            catch (Exception ex)
