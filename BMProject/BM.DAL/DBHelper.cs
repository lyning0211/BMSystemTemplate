...
namespace BM.DAL
{
    ...
    public class DBHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public static string connectionString = ConfigurationManager.ConnectionStrings["BM_DBContext"].ConnectionString;
        #region 构造函数
        public DBHelper()
        {
        }
        ...
        /// </summary>
        public static int ExecuteSql(string pcSQL, params SqlParameter[] cmdParms)
        {
            using (SqlConnection lSqlConnection = new SqlConnection(connectionString))
            {
        ...
        /// </summary>
        public static int ExecuteSql(string pcSQL, SqlTrxHelper Trx, params SqlParameter[] cmdParms)
        {
        ...
        public static object GetSingle(SqlCommand m_SqlCommand)
        {
        ...
        /// <returns></returns>
        public static DataTable GetDataTable(string m_strSqlString, string m_strTableName)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        public static DataTable GetDataTable(string m_strSqlString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        public static DataTable GetDataTable(SqlCommand m_SqlCommand)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataTable dt = new DataTable();
